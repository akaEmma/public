## from Zoni Nation's github repor at https://github.com/zonination/perceptions/blob/master/ztheme.R
...
z_theme <- function() {
    ...
    theme_bw(base_size = 9) +
        ...
        theme(axis.title.x = element_text(size = 16,color = color.axis.title,
                                          vjust = 0)) +
